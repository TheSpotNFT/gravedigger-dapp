...
export const Scribble = ({
    ...
    hover:bg-gray-200 hover:text-gray-900 duration-300 font-mono font-bold text-base" onClick={() => {
            ...
            <div className='flex relative items-center overflow-visible z-[0]'>
                ...
                <div id='slider' className="p-1 pt-4 flex gap-5 xl:flex-row font-mono text-spot-yellow w-full h-full overflow-x-scroll scroll whitespace-nowrap scroll-smooth scrollbar-hide">
                    {ownedCards
