...
export default function Ecosystem() {
  ...
  hover:bg-spot-yellow hover:text-black duration-300 hover:border-white font-mono text-xs md:text-l 2xl:text-xl flex justify-center"
      ...
      {/* Mobile Layout */}
      <div className='block md:hidden text-gray-400 body-font font-mono'>
        ...
        <div className="sm:w-full sm:pl-8 sm:py-8 sm:pr-8 mt-34 pt-4 sm:mt-0 text-center sm:text-left col-span-4">
          <p className="leading-relaxed text-xl text-justify mb-4">Your Goatd NFT is your PFP for the underground. This will represent you in our underground eco-system. <a className="font-bold" href="/goatd">Get yours with the transmorphisizer here.</a> Collect the traits that represent you and build your underground identity.</p>
        </div>
        ...
        <div className="sm:w-full sm:pl-8 sm:py-8 sm:pr-8 mt-34 pt-4 sm:mt-0 text-center sm:text-left col-span-4">
          <p className="leading-relaxed text-xl text-justify mb-4">Your Spot Bot will be the token you actively use in the underground eco-system. We believe in releasing details as we buidl them out, not promising something we aren't 1000% sure will work, so we will be releasing exact details of the Spot Bot's gamification in the coming months.</p>
        </div>
        ...
        <div className="sm:w-full sm:pl-8 sm:py-8 sm:pr-8 mt-34 pt-4 sm:mt-0 text-center sm:text-left col-span-4">
          <p className="leading-relaxed text-xl text-justify mb-4">To be released in Q2 2023, ur wallet's wallet will be storage for everything underground. Without ur wallet's wallet you won't be able to store any underground assets as they roll out. More details to be released as we get closer to mint.</p>
        </div>
        ...
        <div className="sm:w-full sm:pl-8 sm:py-8 sm:pr-8 mt-34 pt-4 sm:mt-0 text-center sm:text-left col-span-4">
          <p className="leading-relaxed text-xl text-justify mb-4">gudVibes will be the first usable asset in the underground's eco-system. Not only will it allow users to claim dNFTs associated with the Vibes project it will act as a token within the underground eco-system.</p>
        </div>
